...
?>
			...
			<div class="box box-primary box-solid table-responsive">
				...
				<div class="box-body table-responsive">
					<a class='btn  btn-success btn-flat' href='?module=trkasir&act=tambah'>MULAI TRANSAKSI</a>
                    ...
                    ?>
					<div></div>
					<!--<a  class ='btn  btn-warning  btn-flat' href='?module=trkasir&act=cari'>PENJUALAN SEBELUMNYA</a>
					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							?>
                                ...
                                <a class='btn btn-success btn-xs' onclick="window.open('modul/mod_laporan/strukresep.php?kd_trkasir=<?php echo $r['kd_trkasir'] ?>',
                                            'nama window','width=500,height=600,toolbar=no,location=no,directories=no,status=no,menubar=no, ' +
                                            'scrollbars=no,resizable=yes,copyhistory=no')">Resep</a>
                ...
                <strong>Klik Sinkronisasi sebelum tutup shift</strong>
			</div>
								...
								<div class='form-group'>
									...
									<label class='col-sm-4 control-label'>Keterangan</label>        		
									    ...
									    <div class='col-sm-7'>
											...
											<div class='buttons'>
												<button type='button' data-toggle='modal' data-target='#ModalTensi' href='#' class='btn btn-success right-block'>
												<i class='glyphicon glyphicon-tint'></i>
												CEK TENSI DARAH</button>
											</div>
										</div>
								</div>
...
<!-- Modal tensi darah -->
<div id="ModalTensi" class="modal fade" role="dialog">
	<div class="modal-md modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">PENGECEKAN TENSI DARAH</h4>
			</div>
