...
?>
		...
		<head>
			<title>KOPERASI BINA MITRA NIAGA</title>
			...
			<div class="wrapper">
				...
				<header class="main-header">
					...
					<a href="#" class="logo">
						...
						<span class="logo-mini"><marquee><b>KOPERASI BINA MITRA NIAGA</b></marquee></span>

						<!-- logo for regular state and mobile devices -->
						<span class="logo-lg"><marquee><b>KOPERASI BINA MITRA NIAGA</b></marquee></span>
					</a>
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown user user-menu">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">
										<img src="images/binamitraniaga.png" class="user-image" alt="User Image">
									...
									<ul class="dropdown-menu">
										...
										<li class="user-header">
											<img src="images/binamitraniaga.png" class="img-circle" alt="User Image">
					...
					<section class="sidebar">
						...
						<div class="user-panel">
							...
							<div class="pull-left info">
								<marquee><p><?php echo $_SESSION['namalengkap'] ?> </p></marquee><br>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								<a href="#">
									<i class="glyphicon glyphicon-list"></i> <span>KESEKRETARIATAN</span> <i class="fa fa-angle-left pull-right"></i>
								</a>
								<ul class="treeview-menu">
									...
									<?php if ($_SESSION['mpelanggan'] == "Y") { ?><li><a href="?module=pelanggan"><i class="fa fa-users"></i> Kehadiran</a></li><?php } ?>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<?php if ($_SESSION['tensidarah'] == "Y") { ?><li><a href="?module=tensidarah"><i class="glyphicon glyphicon-heart"></i> Tensi Darah </a></li><?php } ?>
								</ul>
							</li>
